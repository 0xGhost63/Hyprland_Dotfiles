...
inc_volume() {
    if [ "$(pamixer --get-mute)" == "true" ]; then
        ...
        pamixer -i 15 --allow-boost --set-limit 150 && notify_user
    fi
}
...
inc_mic_volume() {
    if [ "$(pamixer --default-source --get-mute)" == "true" ]; then
        ...
        pamixer --default-source -i 15 && notify_mic_user
    fi
}
...
dec_mic_volume() {
    if [ "$(pamixer --default-source --get-mute)" == "true" ]; then
        ...
        pamixer --default-source -d 15 && notify_mic_user
    fi
}
